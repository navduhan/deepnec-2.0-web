...
prompt_value BIOCLUSTER_REMOTE_SCRIPT 'Absolute HPC path to run_deepnec_web.slurm'
...
prompt_value NEXT_PUBLIC_BASE_PATH 'Public URL base path' '/deepnec-2.0'
...
PREDICTION_MAX_ACTIVE_JOBS="$(current_value PREDICTION_MAX_ACTIVE_JOBS)"; PREDICTION_MAX_ACTIVE_JOBS="${PREDICTION_MAX_ACTIVE_JOBS:-4}"
...
PREDICTION_MAX_SEQUENCES="$(current_value PREDICTION_MAX_SEQUENCES)"; PREDICTION_MAX_SEQUENCES="${PREDICTION_MAX_SEQUENCES:-100}"
PREDICTION_MAX_RESIDUES="$(current_value PREDICTION_MAX_RESIDUES)"; PREDICTION_MAX_RESIDUES="${PREDICTION_MAX_RESIDUES:-100000}"
